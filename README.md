...
Please follow the user manual for installing the tool. If you find our tool useful, please cite our following papers. 
...
2. Akhter, S. and Miller, J.H., BPAGS: A web application for bacteriocin prediction via feature evaluation using alternating decision tree, genetic algorithm, and linear support
